...
export const SUPPORTED_DRIVERS_METADATA: DriverMetadata[] = [
  ...
  },
  {
    ...
    defaultPort: 1433,
    connectionPlaceholder: 'Server=localhost,1433;Database=KriyaDB;User Id=sa;Password=your_password;TrustServerCertificate=true;',
  ...
  },
  {
    ...
    defaultPort: 27017,
    connectionPlaceholder: 'mongodb+srv://admin:password@cluster0.mongodb.net/kriya_database?retryWrites=true&w=majority',
  ...
  },
  {
    ...
    connectionPlaceholder: 'projects/kriya-prod/databases/(default)',
...
export class DatabaseFactory {
  ...
  private constructor() {
    ...
    this.currentConfig = {
      ...
      database: process.env.DATABASE_NAME || 'kriya_db',
      user: process.env.DATABASE_USER || 'root',
      password: process.env.DATABASE_PASSWORD || '',
      projectId: process.env.FIREBASE_PROJECT_ID || 'kriya-prod',
    };
